...
def main(store_category_count_table_file, make_store_id_cont_table_file, train_file, unlabeled_json, model_file, output_file):
    ...
    gbm_pred = ScoringUtilities.make_prediction(model_file, unlabeled_ready2)

    print("{} scored {} records.".format(model_file, len(gbm_pred)))
...
"""
store_category_count_table_file, make_store_id_cont_table_file, train_file, unlabeled_json, model_file, output_file
"""
